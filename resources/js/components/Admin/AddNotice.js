...
class AddNotice extends React.Component {
    ...
    deleteSemCourse = (email, ccode, session) => {
        Swal.fire({
            ...
            if (result.value) {
                ...
                const response = await deleteSpecificSemesterCourse(
                    email,
                    ccode,
                    session
                );
    ...
    EditSemCourse = async (email, ccode, session, id) => {
        const { history } = this.props;
        history.push(
            `${PUBLIC_URL}editSCourse/${email}/${ccode}/${session}/${id}`
        );
    };
    DataToggle = () => {
        $(function() {
                                                                    ...
                                                                    menu: {
                                                                        favs: {
                                                                            title:
                                                                                "My Favorites",
                                                                            items:
                                                                                "code visualaid | searchreplace | emoticons"
                                                                        }
                                                                    },
                                                                    menubar:
    ...
    <input class="form-check-input" type="checkbox" value="checked"> Remember me</input>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            {this.state.SemesterCourseInfo.map(
                                                (row, index) => (
                                                    <tr>
                                                        <td>{i++}</td>
                                                        <td>{row.name}</td>
